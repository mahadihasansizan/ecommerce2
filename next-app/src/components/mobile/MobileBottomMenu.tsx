...
const MobileBottomMenu = () => {
  ...
  const isHomeOrInfoPage = pathname === '/' ||
    pathname === '/faq' ||
    pathname === '/contact';
  ...
  return (
    <>
      <div className={`md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-border z-[90] shadow-lg ${isNative ? 'safe-area-bottom safe-area-x' : ''}`} style={{ transform: 'translateZ(0)' }}>
